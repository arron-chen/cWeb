                ...
                <ul>
                    <li v-for="(item) in posts" :key="item.id">
                        ...
                        <div class="item-cont">
                            ...
                            <div class="item-cont-outline">{{item.content}}</div>
...
export default {
    ...
    created() {},
    mounted() {
        this.getCurrentPost(this.currentPage, this.pageSize)
    },
    filters: {},
    components: { eheader, efooter, ebanner, pagination },
    computed: {
        ...mapState(["articles", "hots", "tags"])
    },
    methods: {
        handleClckPage(params) {
            if (params.num) {
                this.pageSize = params.num;
            }
            this.getCurrentPost(params.i, this.pageSize)
        },
        getCurrentPost(page,pageSize) {
           this.$store
                .dispatch("getIndexArticle", { page: page, pagesize: pageSize })
                .then(res => {
    ...
    .main {
        ...
        .main-right {
            ...
            .right-hot {
                ...
                box-shadow: 1px 2px 6px rgba(63, 74, 105, 0.16);
